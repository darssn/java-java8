...
public class Function_05_Test {
    ...
    Consumer<Person> changePasswordToSecret = pers->pers.setPassword("secret");
			
		
    // TODO compléter la fonction
    // TODO vérifier que l'age > 4 avec une assertion JUnit
    
    Consumer<Person> verifyAge = pers->Assert.assertTrue(pers.getAge()>4);

    // TODO compléter la fonction
    // TODO vérifier que le mot de passe est "secret" avec une assertion JUnit
    
    Consumer<Person> verifyPassword = pers->Assert.assertTrue(pers.getPassword().equals("secret"));
    //end::functions[]
