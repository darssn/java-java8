...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = arg0-> new Person("first_"+arg0,"last_"+arg0,arg0,"pass_"+arg0);
    ...
    private Function<Integer, Account> intToAccountWithCompose = t->personToAccount.compose(intToPerson).apply(t);
    ...
    private Function<Integer, Account> intToAccountWithAndThen = t->intToPerson.andThen(personToAccount).apply(t);
